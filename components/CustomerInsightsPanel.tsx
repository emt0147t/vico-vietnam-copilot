 ...
 * 1. Chân Dung & Định Danh (Who are they?)
 * 2. Nỗi Đau & Động Lực (Why they buy?)
 * 3. Hành Trình Mua Hàng (How they buy?)
 * 4. Tiếng Nói Khách Hàng (Voice of Customer)
 */
        ...
        <div className="space-y-6">
                    ...
                    <div className="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {icp.firmographics.companySize.map((size, idx) => (
                                <span key={idx} className="px-3 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 rounded-lg text-sm font-medium">
                                    {size}
                                </span>
                            ))}
                        </div>
                    ...
                    <div className="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {icp.firmographics.industries.map((ind, idx) => (
                                <span key={idx} className="px-3 py-1 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400 rounded-lg text-sm font-medium">
                                    {ind}
                                </span>
                            ))}
                        </div>
            ...
            <div className="bg-white dark:bg-[#0F1623] border border-gray-100 dark:border-gray-800 rounded-2xl p-6">
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <span className={`text-xs px-2 py-0.5 rounded ${roleColors[dm.role] || 'bg-gray-100 text-gray-600'}`}>
                                            {dm.role}
                                        </span>
                                    </div>
                                </div>
                ...
                <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
                    <p className="text-xs font-bold text-gray-500 uppercase mb-3">Key Influencers</p>
                        ...
                        {icp.keyInfluencers.map((inf, idx) => (
                            <div key={idx} className="flex items-center gap-2 px-3 py-2 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                                <div className={`w-2 h-2 rounded-full ${
                                    ...
                                    inf.influence === 'Medium' ? 'bg-amber-500' : 'bg-gray-400'
                                }`} />
                                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">{inf.title}</span>
                                <span className="text-xs text-gray-400">({inf.focus})</span>
                            </div>
                        ))}
                    </div>
                </div>
        ...
        <div className="bg-white dark:bg-[#0F1623] border border-gray-100 dark:border-gray-800 rounded-2xl overflow-hidden">
            ...
            {isExpanded && (
                <div className="px-5 pb-5 pt-0 space-y-4 border-t border-gray-100 dark:border-gray-800">
                        ...
                        <div className="p-3 bg-green-50 dark:bg-green-900/20 rounded-xl">
                            ...
                            <ul className="space-y-1">
                                {persona.goals.map((g, idx) => (
                                    <li key={idx} className="text-sm text-gray-600 dark:text-gray-300">• {g}</li>
                                ))}
                            </ul>
                        </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {persona.dayInLife.map((activity, idx) => (
                                <span key={idx} className="px-3 py-1 bg-gray-100 dark:bg-gray-800 rounded-lg text-sm text-gray-600 dark:text-gray-300">
                                    {activity}
                                </span>
                            ))}
                        </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-4">
                        <div>
                            <p className="text-xs font-bold text-gray-500 uppercase mb-2">📱 Preferred Channels</p>
                            <div className="flex flex-wrap gap-2">
                        ...
                        <div key={idx} className={`p-4 rounded-xl border-l-4 bg-gray-50 dark:bg-gray-800/50 ${severityColors[pain.severity]?.split(' ').pop()}`}>
                            ...
                            <div className="grid lg:grid-cols-3 gap-3 mt-3 text-sm">
                                <div>
                                    ...
                                    <p className="text-gray-600 dark:text-gray-300">{pain.frequency}</p>
                                </div>
                                <div>
                                    <span className="text-gray-400 text-xs">Current Solution:</span>
                                    <p className="text-gray-600 dark:text-gray-300">{pain.currentSolution}</p>
                                </div>
                                <div>
                                    <span className="text-gray-400 text-xs">Cost of Inaction:</span>
                                    <p className="text-red-600 dark:text-red-400 font-medium">{pain.costOfInaction}</p>
                                </div>
                            </div>
                        </div>
                    ))}
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-3 mt-2 text-sm">
                                        <span className="px-2 py-1 bg-green-200 dark:bg-green-800 rounded text-green-800 dark:text-green-300 font-medium">
                                            {outcome.metric}
                                        </span>
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-1 mt-1">
                                        {trigger.signals.map((sig, i) => (
                                            <span key={i} className="px-2 py-0.5 bg-gray-200 dark:bg-gray-700 rounded text-xs text-gray-600 dark:text-gray-300">
                                                {sig}
                                            </span>
                                        ))}
                                    </div>
                    ...
                    {buyingProcess.map((stage, idx) => (
                        ...
                        >
                            <span className={`w-6 h-6 rounded-full flex items-center justify-center text-xs ${
                                activeStage === idx ? 'bg-white text-blue-600' : 'bg-gray-300 dark:bg-gray-600'
                            }`}>{idx + 1}</span>
                            ...
                            <div className="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {buyingProcess[activeStage].contentNeeded.map((c, idx) => (
                                        <span key={idx} className="px-3 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 rounded-lg text-sm">{c}</span>
                                    ))}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-4 bg-amber-50 dark:bg-amber-900/20 rounded-xl">
                            ...
                            <ul className="space-y-2">
                                {buyingProcess[activeStage].objections.map((obj, idx) => (
                                    <li key={idx} className="text-sm text-gray-600 dark:text-gray-300">"{obj}"</li>
                                ))}
                            </ul>
                        </div>
                    </div>
...
export const CustomerInsightsPanel: React.FC<CustomerInsightsPanelProps> = ({
    ...
    const sections = [
        ...
        { id: 'icp', label: '1. Chân Dung Khách Hàng' },
        { id: 'personas', label: '2. User Personas' },
        { id: 'pain', label: '3. Nỗi Đau & Động Lực' },
        { id: 'journey', label: '4. Hành Trình Mua' },
        { id: 'voc', label: '5. Tiếng Nói Khách Hàng' }
    ];
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-[#0F1623] border border-gray-100 dark:border-gray-800 rounded-2xl p-6">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">Thấu hiểu khách hàng - Tâm lý học hành vi</p>
                    </div>
                </div>
                ...
                <div className="flex gap-3">
                    <input
                        ...
                        className="flex-1 px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                    />
            ...
            {!isLoading && !error && report && (
                <>
                    <div className="flex gap-2 overflow-x-auto pb-2">
                        {sections.map(s => (
                            <button key={s.id} onClick={() => setActiveSection(s.id)} className={`px-4 py-2 rounded-xl text-sm font-medium whitespace-nowrap ${activeSection === s.id ? 'bg-blue-600 text-white' : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300'}`}>
                                {s.label}
                            </button>
                        ))}
                    </div>
                    ...
                    {activeSection === 'overview' && (
                        <div className="bg-white dark:bg-[#0F1623] border border-gray-100 dark:border-gray-800 rounded-2xl p-6">
                            <h3 className="font-bold text-lg text-gray-900 dark:text-white mb-4">Executive Summary</h3>
                            <p className="text-gray-600 dark:text-gray-300 mb-6">{report.executiveSummary.overview}</p>
                            <div className="grid lg:grid-cols-2 gap-6">
                                <div>
                                    <h4 className="font-bold text-gray-900 dark:text-white mb-3">Key Insights</h4>
                                    <ul className="space-y-2">
                                ...
                                <div>
                                    <h4 className="font-bold text-gray-900 dark:text-white mb-3">Recommendations</h4>
                                    <ul className="space-y-2">
            ...
            {!isLoading && !error && !report && (
                <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-2xl border border-blue-200 dark:border-blue-800 p-8 text-center">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Customer Insights Engine</h3>
                    <p className="text-gray-500 mb-4">Nhập tên công ty để tạo phân tích 4 tầng thấu hiểu khách hàng</p>
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 max-w-2xl mx-auto text-sm">
                        <div className="p-3 bg-white dark:bg-gray-800 rounded-xl"><User className="mx-auto text-blue-600 mb-1" size={20} /><p>ICP & Personas</p></div>
                        <div className="p-3 bg-white dark:bg-gray-800 rounded-xl"><AlertTriangle className="mx-auto text-red-600 mb-1" size={20} /><p>Pain Points</p></div>
                        <div className="p-3 bg-white dark:bg-gray-800 rounded-xl"><ArrowRight className="mx-auto text-amber-600 mb-1" size={20} /><p>Buying Journey</p></div>
                        <div className="p-3 bg-white dark:bg-gray-800 rounded-xl"><MessageSquare className="mx-auto text-purple-600 mb-1" size={20} /><p>Voice of Customer</p></div>
                    </div>
                </div>
            )}
        </div>
